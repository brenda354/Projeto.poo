...
pasta = os.path.dirname(__file__) # Caminho onde o script está
pasta_imagens = os.path.join(pasta, 'Imagens')
pasta_sons = os.path.join(pasta, 'Músicas')
...
sprit_zumbi = pygame.image.load(os.path.join(pasta_imagens,'Zumbi.png')).convert_alpha()
