...
Musica_de_fundo = pygame.mixer.music.load('Músicas/Abertura.mp3')
pygame.mixer.music.play(-1)


FONT = pygame.font.Font('Fonts/PeaberryBase.ttf.', 32)

imagem_fundo = pygame.image.load('Backgrounds/cidade.png')
...
class Menu:
    ...
    def run(self):
        ...
        while self.running:
            font_titulo = pygame.font.Font('Fonts/PeaberryBase.ttf', 75)  
